        ...
        <div class="p-16 bg-gray-100">
            <div class="text-center mb-4 opacity-90">
                <a href="#" class="block relative">
                    <img alt="profil" src={Cookies.get('userPhoto')} class="mx-auto object-cover rounded-full h-40 w-40 "/>
                </a>
            </div>
            <div class="text-center">
                ...
                <p class="mx-auto text-md text-gray-500 dark:text-gray-400 max-w-xs py-4 font-light">
                    I am {Cookies.get('userName')}, I love using Joblify.id for hire or seek job vacancies. It's easy to use and friendly for user. Keep it up, Joblify.id!
                </p>
            </div>
