      ...
      <Navbar.Collapse>
          <ul class="flex flex-col p-2 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li className="flex items-center">
              <a href="/" class="block py-2 pr-4 pl-3 text-white bg-sky-800 rounded md:bg-transparent md:text-sky-800 md:p-0 dark:text-white" aria-current="page">Home</a>
            </li>
            <li className="flex items-center">
              <a href="/explore-vacancy" class="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-sky-800 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent" aria-current="page">Explore Jobs Vacancy</a>
            </li>
            {Cookies.get('token') &&
              <li className="flex items-center">
