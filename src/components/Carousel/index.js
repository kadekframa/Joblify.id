  ...
  return (
    ...
    <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
      ...
      <div className="duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-0 z-20" data-carousel-item>
        ...
        <img src="https://ekrutassets.s3.ap-southeast-1.amazonaws.com/blogs/images/000/001/160/original/situs-ikon-vektor-gratis_1-EKRUT.jpg" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
      </div>
      {/* Item 2 */}
      <div className="duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-full z-10" data-carousel-item>
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4SqiKBJU0lI-hhzl_tKXJKQyVV5UAEKfzNmvIdnfyiSg13kiAXRPlffQ8QGXS5YB1UGI&usqp=CAU" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
      </div>
      {/* Item 3 */}
      <div className="duration-700 ease-in-out absolute inset-0 transition-all transform -translate-x-full z-10" data-carousel-item>
