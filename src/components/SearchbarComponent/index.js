    ...
    <div class="searchbar-wrapper grid grid-cols-1 gap-4 sm:grid-cols-10 w-full mt-20 mb-2 pt-6 px-3">
      ...
      <div className="col-span-8">
        <form onSubmit={handleSearch} class="flex items-center">   
            ...
            <button type="submit" class="button-search-mobile-device inline-flex items-center py-2.5 px-6 ml-2 text-sm font-medium text-white bg-sky-700 rounded-lg border border-sky-700 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300 dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800">
